...
const PRESETS: LightPreset[] = [
  {
    // Dawn — warm pink-orange horizon, soft light
    time: 0.25,
    sunColor: new THREE.Color(0xffaa77),
    sunIntensity: 0.8,
    sunElevation: 0.15,
    sunAzimuth: -Math.PI / 3,
    hemiSkyColor: new THREE.Color(0xffd4b0),
    hemiGroundColor: new THREE.Color(0x334422),
    hemiIntensity: 0.4,
    ambientColor: new THREE.Color(0x9988aa),
    ambientIntensity: 0.2,
    skyTop: new THREE.Color(0x4466aa),
    skyBottom: new THREE.Color(0xffccaa),
    fogColor: new THREE.Color(0xddbbaa),
    fogDensity: 0.006,
  },
  {
    // Noon — bright, slightly warm, high sun
    time: 0.5,
    ...
    fogColor: new THREE.Color(0xaaccdd),
    fogDensity: 0.004,
  },
  {
    // Golden hour — the cozy default, warm and low
    time: 0.75,
    sunColor: new THREE.Color(0xffe4b5),
    sunIntensity: 1.5,
    sunElevation: 0.35,
    sunAzimuth: Math.PI / 3,
    hemiSkyColor: new THREE.Color(0xffeedd),
    hemiGroundColor: new THREE.Color(0x445533),
    hemiIntensity: 0.6,
    ambientColor: new THREE.Color(0x8888aa),
    ambientIntensity: 0.15,
    skyTop: new THREE.Color(0x5577aa),
    skyBottom: new THREE.Color(0xffddbb),
    fogColor: new THREE.Color(0xddccbb),
    fogDensity: 0.005,
  },
  {
    // Blue hour — cool twilight, purple-blue tones
    time: 1.0, // wraps to 0.0
    sunColor: new THREE.Color(0x8899bb),
    sunIntensity: 0.3,
    sunElevation: 0.05,
    sunAzimuth: Math.PI * 0.8,
    hemiSkyColor: new THREE.Color(0x6677aa),
    hemiGroundColor: new THREE.Color(0x222233),
    hemiIntensity: 0.3,
